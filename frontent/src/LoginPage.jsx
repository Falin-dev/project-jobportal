...
async function loginAction(_,formData){
    ...
    const result = await fetch("http://127.0.0.1:8000/login-user/"),{
        'method' : "POST",
...
<form action={formAction} className="mt-6 space-y-4">
    ...
    <div>
        ...
        <input type="email" placeholder="Enter your email" className="mt-1 w-full rounded border border-gray-300 px-3 py-2
    ...
    <div>
        ...
        <input type="password" placeholder="Enter your password" className="mt-1 w-full rounded border border-gray-300 px-3 py-2
                focus:border-blue-600 focus:ring-1 focus:ring-blue-200
                outline-none" />
    </div>
